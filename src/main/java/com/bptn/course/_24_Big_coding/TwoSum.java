...
//Summary
//First we intialize the Map with key value pairs 
//then we use for-loop to Loop through each element in the nums array
//Then we Calculate the complement, and check if the complement is found in the HashMap
// If the complement is found, return the index of the complement and the current index 
